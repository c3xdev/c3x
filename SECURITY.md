...
**Do not report vulnerabilities using public GitHub issues**. Instead, email [security@c3x.dev](mailto:security@c3x.dev) with a detailed account of the issue. Please submit one issue per email, this helps us triage vulnerabilities.
