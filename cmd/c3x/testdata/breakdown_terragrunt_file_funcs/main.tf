...
locals {
  files = [
    ...
    {
      name = "abs",
      file = "/home/runner/work/c3x/c3x/cmd/c3x/testdata/breakdown_terraform_file_funcs/instance.json",
    },
    { name = "pdabs", file = "/home/runner/work/c3x/c3x/cmd/testdata/instance.json", },
  ]
  dirs = [
    { name = "cd", dir = "." },
    { name = "pd", dir = "../../../testdata" },
    { name = "abs", dir = "/home/runner/work/c3x/c3x/cmd/c3x/testdata/breakdown_terraform_file_funcs/" },
    { name = "pdabs", dir = "/home/runner/work/c3x/c3x/cmd/testdata/" },
  ...
  template_files = [
    ...
    {
      name = "abs", file = "/home/runner/work/c3x/c3x/cmd/c3x/testdata/breakdown_terraform_file_funcs/templ.tftpl",
    },
    { name = "pdabs", file = "/home/runner/work/c3x/c3x/cmd/testdata/templ.tftpl", }
  ]
}
