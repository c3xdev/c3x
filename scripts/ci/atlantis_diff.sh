...
#
# Please follow our guide: https://www.c3x.dev/docs/guides/atlantis_migration/ to migrate
# to our new Atlantis integration: https://github.com/c3xdev/c3x-atlantis
#
...
if [ "$atlantis_debug" = "true" ] || [ "$atlantis_debug" = "True" ] || [ "$atlantis_debug" = "TRUE" ]; then
  ...
  echo "Please visit https://www.c3x.dev/docs/guides/atlantis_migration/ for instructions on how to upgrade."
  echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
  echo

  echo "#####"
  echo "Running C3X atlantis_diff.sh in debug mode, remove atlantis_debug=true from Atlantis configs to disable debug outputs."
  echo
fi
...
process_args () {
  ...
  export C3X_CI_ATLANTIS_DIFF=true
}
