...
// CatalogItem is the new/preferred way to represent provider-agnostic resources that
// support advanced features such as C3X Cloud usage estimates and actual costs.
...
func (b BlankCoreResource) UsageSchema() []*ConsumptionField    { return nil }
...
// CatalogItemWithConsumptionParams is a CoreResource that sends additional
...
// UnpricedEntry is used to collect all information required to construct a
...
// (such as C3X Cloud usage estimates) before the resource is built.
