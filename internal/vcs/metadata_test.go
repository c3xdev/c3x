...
import (
	...
	"github.com/c3xdev/c3x/internal/sync"
)
...
func Test_urlStringToRemote(t *testing.T) {
	tests := []struct {
		...
		{"git@bitbucket.org:8888/~test.c3x.dev/c3x-bitbucket-pipeline.git", Remote{
			Host: "bitbucket.org",
			Name: "~test.c3x.dev/c3x-bitbucket-pipeline",
			URL:  "https://bitbucket.org:8888/~test.c3x.dev/c3x-bitbucket-pipeline.git",
		}},
	}
...
func Test_metadataFetcher_GetLocalMetadataMergesWithEnv(t *testing.T) {
	...
	t.Setenv("GITHUB_ACTIONS", "")
	t.Setenv("C3X_VCS_COMMIT_AUTHOR_NAME", providedName)

	pullID := "1234"
	t.Setenv("C3X_VCS_PULL_REQUEST_ID", pullID)
...
func Test_metadataFetcher_Get_ReturnsUserDefinedEnvs(t *testing.T) {
	...
	t.Setenv("C3X_VCS_PULL_REQUEST_ID", "C3X_VCS_PULL_REQUEST_ID_VALUE")
	t.Setenv("C3X_VCS_PROVIDER", "github")
	t.Setenv("C3X_VCS_PULL_REQUEST_TITLE", "C3X_VCS_PULL_REQUEST_TITLE_VALUE")
	t.Setenv("C3X_VCS_PULL_REQUEST_AUTHOR", "C3X_VCS_PULL_REQUEST_AUTHOR_VALUE")
	t.Setenv("C3X_VCS_PULL_REQUEST_LABELS", "C3X_VCS_PULL_REQUEST_LABELS_VALUE_1, C3X_VCS_PULL_REQUEST_LABELS_VALUE_2")
	t.Setenv("C3X_VCS_BRANCH", "C3X_BRANCH_VALUE")
	t.Setenv("C3X_VCS_BASE_BRANCH", "C3X_VCS_BASE_BRANCH_VALUE")
	t.Setenv("C3X_VCS_PULL_REQUEST_URL", "https://github.com/c3xdev/test-repo/pull/1979")
	t.Setenv("C3X_VCS_COMMIT_SHA", "C3X_COMMIT_VALUE")
	t.Setenv("C3X_VCS_COMMIT_AUTHOR_NAME", "C3X_COMMIT_AUTHOR_NAME_VALUE")
	t.Setenv("C3X_VCS_COMMIT_AUTHOR_EMAIL", "C3X_COMMIT_AUTHOR_EMAIL_VALUE")
	timestamp := fmt.Sprintf("%d", tt.Unix())
	t.Setenv("C3X_VCS_COMMIT_TIMESTAMP", timestamp)
	t.Setenv("C3X_VCS_COMMIT_MESSAGE", "C3X_COMMIT_MESSAGE_VALUE")
	t.Setenv("C3X_VCS_REPOSITORY_URL", "https://github.com/c3xdev/test-repo.git")
	t.Setenv("C3X_VCS_BRANCH", "C3X_BRANCH_VALUE")
	t.Setenv("C3X_VCS_PIPELINE_RUN_ID", "C3X_VCS_PIPELINE_RUN_ID_VALUE")
	...
	assert.Equal(t, Metadata{
		Remote: Remote{
			Host: "github.com",
			Name: "c3xdev/test-repo",
			URL:  "https://github.com/c3xdev/test-repo.git",
		},
		Branch: Branch{
			Name: "C3X_BRANCH_VALUE",
		},
		Commit: Commit{
			SHA:         "C3X_COMMIT_VALUE",
			AuthorName:  "C3X_COMMIT_AUTHOR_NAME_VALUE",
			AuthorEmail: "C3X_COMMIT_AUTHOR_EMAIL_VALUE",
			Time:        tt,
			Message:     "C3X_COMMIT_MESSAGE_VALUE",
		},
		PullRequest: &PullRequest{
			ID:           "C3X_VCS_PULL_REQUEST_ID_VALUE",
			VCSProvider:  "github",
			Title:        "C3X_VCS_PULL_REQUEST_TITLE_VALUE",
			Author:       "C3X_VCS_PULL_REQUEST_AUTHOR_VALUE",
			Labels:       []string{"C3X_VCS_PULL_REQUEST_LABELS_VALUE_1", "C3X_VCS_PULL_REQUEST_LABELS_VALUE_2"},
			SourceBranch: "C3X_BRANCH_VALUE",
			BaseBranch:   "C3X_VCS_BASE_BRANCH_VALUE",
			URL:          "https://github.com/c3xdev/test-repo/pull/1979",
		},
		Pipeline: &Pipeline{ID: "C3X_VCS_PIPELINE_RUN_ID_VALUE"},
	}, actual)
}
