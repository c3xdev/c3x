...
func (r *MQBroker) UsageSchema() []*engine.ConsumptionField {
	return []*engine.ConsumptionField{{Key: "storage_size_gb", ValueType: engine.Float64, DefaultValue: 0}}
}
...
func (r *MQBroker) instanceUsageCostComponent() *engine.LineItem {
...
func (r *MQBroker) storageCostComponent() *engine.LineItem {
