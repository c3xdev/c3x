...
func (r *APIGatewayV2API) UsageSchema() []*engine.ConsumptionField {
	return []*engine.ConsumptionField{
		{Key: "message_size_kb", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_connection_mins", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_requests", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "request_size_kb", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_messages", ValueType: engine.Int64, DefaultValue: 0},
	}
}
...
func (r *APIGatewayV2API) httpAPICostComponent() []*engine.LineItem {
...
func (r *APIGatewayV2API) websocketAPICostComponent() []*engine.LineItem {
...
func (r *APIGatewayV2API) httpCostComponent(displayName string, usageTier string, monthlyQuantity *decimal.Decimal) *engine.LineItem {
...
func (r *APIGatewayV2API) websocketCostComponent(unit string, usageType string, displayName string, usageTier string, monthlyQuantity *decimal.Decimal) *engine.LineItem {
	return &engine.LineItem{
		Name:            displayName,
		Unit:            "1M " + unit,
		UnitMultiplier:  decimal.NewFromInt(1000000),
