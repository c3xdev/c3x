...
func (r *EC2ClientVPNNetworkAssociation) UsageSchema() []*engine.ConsumptionField {
	return []*engine.ConsumptionField{}
}

func (r *EC2ClientVPNNetworkAssociation) PopulateUsage(u *engine.ConsumptionProfile) {
