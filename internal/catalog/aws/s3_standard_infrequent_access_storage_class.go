...
func (a *S3StandardInfrequentAccessStorageClass) UsageSchema() []*engine.ConsumptionField {
...
func (a *S3StandardInfrequentAccessStorageClass) PopulateUsage(u *engine.ConsumptionProfile) {
	catalog.PopulateArgsWithUsage(a, u)
}

func (a *S3StandardInfrequentAccessStorageClass) BuildResource() *engine.Estimate {
