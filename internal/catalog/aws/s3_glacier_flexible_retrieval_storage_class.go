...
func (a *S3GlacierFlexibleRetrievalStorageClass) UsageSchema() []*engine.ConsumptionField {
...
func (a *S3GlacierFlexibleRetrievalStorageClass) PopulateUsage(u *engine.ConsumptionProfile) {
	catalog.PopulateArgsWithUsage(a, u)
}

func (a *S3GlacierFlexibleRetrievalStorageClass) BuildResource() *engine.Estimate {
