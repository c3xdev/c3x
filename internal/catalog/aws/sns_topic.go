...
func (r *SNSTopic) apiRequestsCostComponent(requests *int64) *engine.LineItem {
...
func (r *SNSTopic) httpNotificationsCostComponent(subscriptions, requests *int64) *engine.LineItem {
...
func (r *SNSTopic) emailNotificationsCostComponent(subscriptions, requests *int64) *engine.LineItem {
	return r.notificationsCostComponent(
...
func (r *SNSTopic) kinesisNotificationsCostComponent(subscriptions, requests *int64) *engine.LineItem {
	return r.notificationsCostComponent(
...
func (r *SNSTopic) mobilePushNotificationsCostComponent(subscriptions, requests *int64) *engine.LineItem {
	return r.notificationsCostComponent(
...
func (r *SNSTopic) macOSNotificationsCostComponent(subscriptions, requests *int64) *engine.LineItem {
	return r.notificationsCostComponent(
		"MacOS notifications",
		"1M notifications",
		1000000,
...
func (r *SNSTopic) smsNotificationsCostComponent(subscriptions, requests *int64) *engine.LineItem {
...
// PopulateUsage parses the u engine.ConsumptionProfile into the SNSTopic.
// It uses the `c3x_usage` struct tags to populate data into the SNSTopic.
func (r *SNSTopic) PopulateUsage(u *engine.ConsumptionProfile) {
	catalog.PopulateArgsWithUsage(r, u)
}

// BuildResource builds a engine.Estimate from a valid SNSTopic struct.
...
func (r *SNSTopic) notificationsCostComponent(name, unit string, multiplier int64, usageType string, startUsageAmount int64, subscribers, requests *int64) *engine.LineItem {
...
// func (r *SNSFIFOTopic) CostComponents() []*engine.LineItem {
//	return []*engine.LineItem{
...
func (r *SNSFIFOTopic) publishAPIRequestsCostComponent(requests *int64) *engine.LineItem {
	var q *decimal.Decimal
	if requests != nil {
...
func (r *SNSFIFOTopic) publishAPIPayloadCostComponent(requests *int64, requestSizeGB *float64) *engine.LineItem {
	var q *decimal.Decimal
...
func (r *SNSFIFOTopic) notificationsCostComponent(subscriptions int64, requests *int64) *engine.LineItem {
	var q *decimal.Decimal
	if subscriptions == 0 {
		q = &decimal.Zero
...
func (r *SNSFIFOTopic) notificationPayloadCostComponent(subscriptions int64, requests *int64, requestSizeGB *float64) *engine.LineItem {
	var q *decimal.Decimal
	if subscriptions == 0 {
		q = &decimal.Zero
...
// PopulateUsage parses the u engine.ConsumptionProfile into the SNSFIFOTopic.
// It uses the `c3x_usage` struct tags to populate data into the SNSFIFOTopic.
func (r *SNSFIFOTopic) PopulateUsage(u *engine.ConsumptionProfile) {
	catalog.PopulateArgsWithUsage(r, u)
}

// BuildResource builds a engine.Estimate from a valid SNSFIFOTopic struct.
// This method is called after the resource is initialised by an IaC provider.
// See providers folder for more information.
