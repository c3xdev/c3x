...
func (a *LambdaFunction) UsageSchema() []*engine.ConsumptionField {
	return []*engine.ConsumptionField{
		{Key: "request_duration_ms", DefaultValue: 0, ValueType: engine.Int64},
		{Key: "monthly_requests", DefaultValue: 0, ValueType: engine.Int64},
	}
}

func (a *LambdaFunction) UsageEstimationParams() []engine.ConsumptionParam {
	return []engine.ConsumptionParam{
...
func (a *LambdaFunction) durationCostComponent(displayName string, usageTier string, quantity *decimal.Decimal, durationType string) *engine.LineItem {
...
func (a *LambdaFunction) storageCostComponent(quantity *decimal.Decimal, storageType string) *engine.LineItem {
	return &engine.LineItem{
