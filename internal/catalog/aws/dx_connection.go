...
func (r *DXConnection) UsageSchema() []*engine.ConsumptionField {
	return []*engine.ConsumptionField{
		...
		{Key: "monthly_outbound_region_to_dx_location_gb", ValueType: engine.Float64, DefaultValue: 0},
		{Key: "dx_virtual_interface_type", ValueType: engine.String, DefaultValue: "private"},
		{Key: "dx_connection_type", ValueType: engine.String, DefaultValue: "dedicated"},
	}
}
...
func (r *DXConnection) BuildResource() *engine.Estimate {
	components := []*engine.LineItem{r.connectionComponent()}
...
func (r *DXConnection) connectionComponent() *engine.LineItem {
...
func (r *DXConnection) outboundDataTransferComponent(fromRegion string, dataProcessedGB *decimal.Decimal) *engine.LineItem {
