...
var globalAcceleratorRegionDataTransferUsageSchema = []*engine.ConsumptionField{
	...
	{Key: "south_korea", DefaultValue: 0, ValueType: engine.Float64},
	...
	{Key: "middle_east", DefaultValue: 0, ValueType: engine.Float64},
}
...
type globalAcceleratorRegionDataTransferUsage struct {
	...
	SouthKorea   *float64 `c3x_usage:"south_korea"`
	Australia    *float64 `c3x_usage:"australia"`
	AsiaPacific  *float64 `c3x_usage:"asia_pacific"`
	MiddleEast   *float64 `c3x_usage:"middle_east"`
...
func (r *GlobalacceleratorEndpointGroup) UsageSchema() []*engine.ConsumptionField {
...
func (r *GlobalacceleratorEndpointGroup) PopulateUsage(u *engine.ConsumptionProfile) {
...
func (r *GlobalacceleratorEndpointGroup) buildSubresources() []*engine.Estimate {
	var (
...
func (r *GlobalacceleratorEndpointGroup) buildRegionSubresource(regionData *globalAcceleratorRegionData, trafficDirection string) *engine.Estimate {
