...
func (r *CognitiveAccountSpeech) UsageSchema() []*engine.ConsumptionField {
	return []*engine.ConsumptionField{
		// Speech to text
		{Key: "monthly_speech_to_text_hrs", ValueType: engine.Float64, DefaultValue: 0},
		{Key: "monthly_speech_to_text_custom_hrs", ValueType: engine.Float64, DefaultValue: 0},
		{Key: "monthly_speech_to_text_batch_hrs", ValueType: engine.Float64, DefaultValue: 0},
		{Key: "monthly_speech_to_text_custom_batch_hrs", ValueType: engine.Float64, DefaultValue: 0},
		{Key: "monthly_speech_to_text_custom_endpoint_hrs", ValueType: engine.Float64, DefaultValue: 0},
		{Key: "monthly_speech_to_text_conversation_transcription_multi_channel_audio_hrs", ValueType: engine.Float64, DefaultValue: 0},
		{Key: "monthly_speech_to_text_custom_training_hrs", ValueType: engine.Float64, DefaultValue: 0},
		{Key: "monthly_speech_to_text_enhanced_add_ons_hrs", ValueType: engine.Float64, DefaultValue: 0},
		// Text to speech
		{Key: "monthly_text_to_speech_neural_chars", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_text_to_speech_custom_neural_training_hrs", ValueType: engine.Float64, DefaultValue: 0},
		{Key: "monthly_text_to_speech_custom_neural_chars", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_text_to_speech_custom_neural_endpoint_hrs", ValueType: engine.Float64, DefaultValue: 0},
		{Key: "monthly_text_to_speech_long_audio_chars", ValueType: engine.Float64, DefaultValue: 0},
		{Key: "monthly_text_to_speech_personal_voice_profiles", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_text_to_speech_personal_voice_chars", ValueType: engine.Int64, DefaultValue: 0},
		// Speech translation
		{Key: "monthly_speech_translation_hrs", ValueType: engine.Float64, DefaultValue: 0},
		// Speaker recognition
		{Key: "monthly_speaker_verification_transactions", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_speaker_identification_transactions", ValueType: engine.Int64, DefaultValue: 0},
		// Voice storage
		{Key: "monthly_voice_profiles", ValueType: engine.Int64, DefaultValue: 0},

		// Standard commitment tier
		{Key: "monthly_commitment_speech_to_text_standard_hrs", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_commitment_speech_to_text_standard_overage_hrs", ValueType: engine.Float64, DefaultValue: 0},
		{Key: "monthly_commitment_speech_to_text_custom_hrs", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_commitment_speech_to_text_custom_overage_hrs", ValueType: engine.Float64, DefaultValue: 0},
		{Key: "monthly_commitment_speech_to_text_enhanced_add_ons_hrs", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_commitment_speech_to_text_enhanced_add_ons_overage_hrs", ValueType: engine.Float64, DefaultValue: 0},
		{Key: "monthly_commitment_text_to_speech_neural_commitment_chars", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_commitment_text_to_speech_neural_overage_chars", ValueType: engine.Int64, DefaultValue: 0},

		// Connected container
		{Key: "monthly_connected_container_commitment_speech_to_text_standard_hrs", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_connected_container_commitment_speech_to_text_standard_overage_hrs", ValueType: engine.Float64, DefaultValue: 0},
		{Key: "monthly_connected_container_commitment_speech_to_text_custom_hrs", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_connected_container_commitment_speech_to_text_custom_overage_hrs", ValueType: engine.Float64, DefaultValue: 0},
		{Key: "monthly_connected_container_commitment_speech_to_text_enhanced_add_ons_hrs", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_connected_container_commitment_speech_to_text_enhanced_add_ons_overage_hrs", ValueType: engine.Float64, DefaultValue: 0},
		{Key: "monthly_connected_container_commitment_text_to_speech_neural_commitment_chars", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_connected_container_commitment_text_to_speech_neural_overage_chars", ValueType: engine.Int64, DefaultValue: 0},
	}
}

// PopulateUsage parses the u engine.ConsumptionProfile into the CognitiveAccountSpeech.
// It uses the `c3x_usage` struct tags to populate data into the CognitiveAccountSpeech.
func (r *CognitiveAccountSpeech) PopulateUsage(u *engine.ConsumptionProfile) {
	catalog.PopulateArgsWithUsage(r, u)
}

// BuildResource builds a engine.Estimate from a valid CognitiveAccountSpeech struct.
...
func (r *CognitiveAccountSpeech) costComponents() []*engine.LineItem {
	...
	costComponents = append(costComponents, []*engine.LineItem{
		...
		r.s0CostComponent("Speech to text custom endpoint hosting", "S1 Custom Speech Model Hosting Unit", floatPtrToDecimalPtr(r.MonthlySpeechToTextCustomEndpointHrs), "hours", 1, &engine.RateSelector{Unit: strPtr("1/Hour")}), // This uses a different unit, so we don't want to filter the price by '1 Hour'
	...
	costComponents = append(costComponents, []*engine.LineItem{
		...
		r.s0CostComponent("Text to speech custom neural endpoint hosting", "S1 Custom Neural Voice Model Hosting Unit", floatPtrToDecimalPtr(r.MonthlyTextToSpeechCustomNeuralEndpointHrs), "hours", 1, &engine.RateSelector{Unit: strPtr("1/Hour")}), // This uses a different unit, so we don't want to filter the price by '1 Hour'
...
func (r *CognitiveAccountSpeech) s0CostComponent(name string, meterName string, qty *decimal.Decimal, unit string, qtyDiv int64, priceFilter *engine.RateSelector) *engine.LineItem {
	if qty != nil {
...
func (r *CognitiveAccountSpeech) s0HourlyCostComponent(name string, meterName string, hours *float64) *engine.LineItem {
	var qty *decimal.Decimal
	if hours != nil {
		qty = decimalPtr(decimal.NewFromFloat(*hours))
	}

	return r.s0CostComponent(name, meterName, qty, "hours", 1, &engine.RateSelector{Unit: strPtr("1 Hour")})
}

func (r *CognitiveAccountSpeech) personalVoiceCostComponents() []*engine.LineItem {
...
func (r *CognitiveAccountSpeech) commitmentTierCostComponents(namePrefix string, commitmentTierType int, skuNamePrefix string, commitedAmount int64, overage *decimal.Decimal, unit string, qtyDiv int64) []*engine.LineItem {
...
func (r *CognitiveAccountSpeech) commitmentTierHourlyCostComponents(namePrefix string, commitmentTierType int, skuNamePrefix string, amount int64, overage *decimal.Decimal) []*engine.LineItem {
