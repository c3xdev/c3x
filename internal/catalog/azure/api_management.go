...
func (r *APIManagement) UsageSchema() []*engine.ConsumptionField {
	return []*engine.ConsumptionField{{Key: "self_hosted_gateway_count", ValueType: engine.Int64, DefaultValue: 0}, {Key: "monthly_api_calls", ValueType: engine.Int64, DefaultValue: 0}}
}
...
func (r *APIManagement) apiManagementCostComponent(name, unit, tier string, quantity *decimal.Decimal, usageBased bool) *engine.LineItem {
...
func (r *APIManagement) consumptionAPICostComponent(tier string, quantity *decimal.Decimal) *engine.LineItem {
	return &engine.LineItem{
