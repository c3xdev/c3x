...
func (r *CognitiveDeployment) UsageSchema() []*engine.ConsumptionField {
	return []*engine.ConsumptionField{
		{Key: "monthly_language_input_tokens", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_language_output_tokens", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_code_interpreter_sessions", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_base_model_tokens", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_fine_tuning_training_hours", ValueType: engine.Float64, DefaultValue: 0},
		{Key: "monthly_fine_tuning_hosting_hours", ValueType: engine.Float64, DefaultValue: 0},
		{Key: "monthly_fine_tuning_input_tokens", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_fine_tuning_output_tokens", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_standard_1024_1024_images", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_standard_1024_1792_images", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_hd_1024_1024_images", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_hd_1024_1792_images", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_text_embeddings", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_text_to_speech_characters", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_text_to_speech_hours", ValueType: engine.Float64, DefaultValue: 0},
		{Key: "monthly_audio_input_tokens", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_audio_output_tokens", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_file_search_tool_calls", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_file_search_storage_gb", ValueType: engine.Float64, DefaultValue: 0},
	}
}

// PopulateUsage parses the u engine.ConsumptionProfile into the CognitiveDeployment.
// It uses the `c3x_usage` struct tags to populate data into the CognitiveDeployment.
func (r *CognitiveDeployment) PopulateUsage(u *engine.ConsumptionProfile) {
	catalog.PopulateArgsWithUsage(r, u)
}

// BuildResource builds a engine.Estimate from a valid CognitiveDeployment struct.
...
func (r *CognitiveDeployment) audioCostComponents() []*engine.LineItem {
	version := r.Version
	if version == "" {
...
func (r *CognitiveDeployment) languageCostComponents() []*engine.LineItem {
	modelName := r.Model
	version := r.Version
	if version == "" {
		version = languageModelDefaultVersions[r.Model]
...
func (r *CognitiveDeployment) baseModelCostComponents() []*engine.LineItem {
...
func (r *CognitiveDeployment) fineTuningCostComponents() []*engine.LineItem {
...
func (r *CognitiveDeployment) imageCostComponents() []*engine.LineItem {
...
func (r *CognitiveDeployment) embeddingCostComponents() []*engine.LineItem {
...
func (r *CognitiveDeployment) speechCostComponents() []*engine.LineItem {
...
func (r *CognitiveDeployment) toolCallsCostComponents() []*engine.LineItem {
