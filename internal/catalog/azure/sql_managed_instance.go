...
// PopulateUsage parses the u engine.ConsumptionProfile into the SQLManagedInstance.
// It uses the `c3x_usage` struct tags to populate data into the SQLManagedInstance.
func (r *SQLManagedInstance) PopulateUsage(u *engine.ConsumptionProfile) {
	catalog.PopulateArgsWithUsage(r, u)
}

// BuildResource builds a engine.Estimate from a valid SQLManagedInstance struct.
...
func (r *SQLManagedInstance) costComponents() []*engine.LineItem {
...
func (r *SQLManagedInstance) sqlMIStorageCostComponent() *engine.LineItem {
...
func (r *SQLManagedInstance) sqlMIBackupCostComponent() *engine.LineItem {
...
func (r *SQLManagedInstance) sqlMILicenseCostComponent() *engine.LineItem {
	return &engine.LineItem{
		Name:           "SQL license",
		Unit:           "vCore-hours",
		UnitMultiplier: decimal.NewFromInt(1),
...
func (r *SQLManagedInstance) sqlMILongTermRetentionStorageGBCostComponent() *engine.LineItem {
