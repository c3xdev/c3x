...
func (r *CognitiveAccountLUIS) UsageSchema() []*engine.ConsumptionField {
	return []*engine.ConsumptionField{
		{Key: "monthly_luis_text_requests", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_luis_speech_requests", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_commitment_luis_text_requests", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_commitment_luis_text_overage_requests", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_connected_container_commitment_luis_text_requests", ValueType: engine.Int64, DefaultValue: 0},
		{Key: "monthly_connected_container_commitment_luis_text_overage_requests", ValueType: engine.Int64, DefaultValue: 0},
	}
}

// PopulateUsage parses the u engine.ConsumptionProfile into the CognitiveAccountLUIS.
// It uses the `c3x_usage` struct tags to populate data into the CognitiveAccountLUIS.
func (r *CognitiveAccountLUIS) PopulateUsage(u *engine.ConsumptionProfile) {
	catalog.PopulateArgsWithUsage(r, u)
}

// BuildResource builds a engine.Estimate from a valid CognitiveAccountLUIS struct.
...
func (r *CognitiveAccountLUIS) textRequestsCostComponent() *engine.LineItem {
...
func (r *CognitiveAccountLUIS) commitmentTextRequestsCostComponents() []*engine.LineItem {
...
func (r *CognitiveAccountLUIS) connectedContainerCommitmentTextRequestsCostComponents() []*engine.LineItem {
...
func (r *CognitiveAccountLUIS) speechRequestsCostComponent() *engine.LineItem {
	var qty *decimal.Decimal
	...
	c := &engine.LineItem{
		...
		ProductFilter: &engine.ProductSelector{
			...
			AttributeFilters: []*engine.AttributeMatch{
				{Key: "productName", Value: strPtr("Language Understanding")},
				{Key: "meterName", Value: strPtr("S1 Speech To Intent - Understanding Transactions")},
			},
		},
	}
