...
func (r *CognitiveAccountLanguage) UsageSchema() []*engine.ConsumptionField {
	return []*engine.ConsumptionField{
		{Key: "monthly_language_text_analytics_records", DefaultValue: 0, ValueType: engine.Int64},
		{Key: "monthly_language_summarization_records", DefaultValue: 0, ValueType: engine.Int64},

		{Key: "monthly_language_conversational_language_understanding_records", DefaultValue: 0, ValueType: engine.Int64},
		{Key: "monthly_language_conversational_language_understanding_advanced_training_hours", DefaultValue: 0, ValueType: engine.Float64},
		{Key: "monthly_language_customized_text_classification_records", DefaultValue: 0, ValueType: engine.Int64},
		{Key: "monthly_language_customized_summarization_records", DefaultValue: 0, ValueType: engine.Int64},
		{Key: "monthly_language_customized_question_answering_records", DefaultValue: 0, ValueType: engine.Int64},
		{Key: "monthly_language_customized_training_hours", DefaultValue: 0, ValueType: engine.Float64},
		{Key: "monthly_language_text_analytics_for_health_records", DefaultValue: 0, ValueType: engine.Int64},

		// Commitment tiers
		{Key: "monthly_commitment_language_text_analytics_records", DefaultValue: 0, ValueType: engine.Int64},
		{Key: "monthly_commitment_language_text_analytics_overage_records", DefaultValue: 0, ValueType: engine.Int64},
		{Key: "monthly_commitment_language_summarization_records", DefaultValue: 0, ValueType: engine.Int64},
		{Key: "monthly_commitment_language_summarization_overage_records", DefaultValue: 0, ValueType: engine.Int64},
		{Key: "monthly_connected_container_commitment_language_text_analytics_records", DefaultValue: 0, ValueType: engine.Int64},
		{Key: "monthly_connected_container_commitment_language_text_analytics_overage_records", DefaultValue: 0, ValueType: engine.Int64},
		{Key: "monthly_connected_container_commitment_language_summarization_records", DefaultValue: 0, ValueType: engine.Int64},
		{Key: "monthly_connected_container_commitment_language_summarization_overage_records", DefaultValue: 0, ValueType: engine.Int64},
	}
}

// PopulateUsage parses the u engine.ConsumptionProfile into the CognitiveAccountLanguage.
// It uses the `c3x_usage` struct tags to populate data into the CognitiveAccountLanguage.
func (r *CognitiveAccountLanguage) PopulateUsage(u *engine.ConsumptionProfile) {
	catalog.PopulateArgsWithUsage(r, u)
}

// BuildResource builds a engine.Estimate from a valid CognitiveAccountLanguage struct.
...
func (r *CognitiveAccountLanguage) textAnalyticsCostComponents() []*engine.LineItem {
...
func (r *CognitiveAccountLanguage) textAnalyticsCostComponent(suffix string, startUsage string, qty *decimal.Decimal) *engine.LineItem {
...
func (r *CognitiveAccountLanguage) commitmentTextAnalyticsCostComponents(commitmentTierType int64, amount int64, overage *decimal.Decimal) []*engine.LineItem {
...
func (r *CognitiveAccountLanguage) summarizationCostComponent() *engine.LineItem {
	var qty *decimal.Decimal
...
func (r *CognitiveAccountLanguage) commitmentSummarizationCostComponents(commitmentTierType int64, amount int64, overage *decimal.Decimal) []*engine.LineItem {
...
func (r *CognitiveAccountLanguage) conversationalLanguageUnderstandingCostComponent() *engine.LineItem {
	var qty *decimal.Decimal
...
func (r *CognitiveAccountLanguage) conversationalLanguageUnderstandingAdvancedTrainingCostComponent() *engine.LineItem {
	var qty *decimal.Decimal
...
func (r *CognitiveAccountLanguage) customizedTextClassificationCostComponent() *engine.LineItem {
	var qty *decimal.Decimal
...
func (r *CognitiveAccountLanguage) customizedSummarizationCostComponent() *engine.LineItem {
	var qty *decimal.Decimal
...
func (r *CognitiveAccountLanguage) customizedQuestionAnsweringCostComponents() []*engine.LineItem {
	var costComponents []*engine.LineItem
...
func (r *CognitiveAccountLanguage) customizedQuestionAnsweringCostComponent(suffix string, startUsage string, qty *decimal.Decimal) *engine.LineItem {
	return &engine.LineItem{
...
func (r *CognitiveAccountLanguage) customizedTrainingCostComponent() *engine.LineItem {
	var qty *decimal.Decimal
...
func (r *CognitiveAccountLanguage) textAnalyticsForHealthCostComponents() []*engine.LineItem {
	var costComponents []*engine.LineItem
...
func (r *CognitiveAccountLanguage) textAnalyticsForHealthCostComponent(suffix string, startUsage string, qty *decimal.Decimal) *engine.LineItem {
	return &engine.LineItem{
