...
func (r *StorageAccount) UsageSchema() []*engine.ConsumptionField {
	return []*engine.ConsumptionField{
		...
		{Key: "monthly_iterative_read_operations", DefaultValue: 0, ValueType: engine.Int64},
		{Key: "monthly_read_operations", DefaultValue: 0, ValueType: engine.Int64},
		{Key: "monthly_iterative_write_operations", DefaultValue: 0, ValueType: engine.Int64},
		{Key: "monthly_write_operations", DefaultValue: 0, ValueType: engine.Int64},
		{Key: "monthly_list_and_create_container_operations", DefaultValue: 0, ValueType: engine.Int64},
		...
		{Key: "monthly_data_write_gb", DefaultValue: 0, ValueType: engine.Float64},
		{Key: "blob_index_tags", DefaultValue: 0, ValueType: engine.Int64},
		{Key: "data_at_rest_storage_gb", DefaultValue: 0, ValueType: engine.Float64},
		...
		{Key: "early_deletion_gb", DefaultValue: 0, ValueType: engine.Float64},
	}
}

// PopulateUsage parses the u engine.ConsumptionProfile into the StorageAccount.
// It uses the `c3x_usage` struct tags to populate data into the StorageAccount.
func (r *StorageAccount) PopulateUsage(u *engine.ConsumptionProfile) {
	catalog.PopulateArgsWithUsage(r, u)
}

// BuildResource builds a engine.Estimate from valid StorageAccount data.
...
func (r *StorageAccount) buildProductFilter(meterName string) *engine.ProductSelector {
...
func (r *StorageAccount) storageCostComponents() []*engine.LineItem {
	costComponents := []*engine.LineItem{}
...
//
// FileStorage: n/a
func (r *StorageAccount) iterativeWriteOperationsCostComponents() []*engine.LineItem {
	costComponents := []*engine.LineItem{}
...
//	Standard Cool: cost exists
//	Premium:       no cost
func (r *StorageAccount) writeOperationsCostComponents() []*engine.LineItem {
	costComponents := []*engine.LineItem{}
...
//	Standard Cool: cost exists
//	Premium:       no cost
func (r *StorageAccount) listAndCreateContainerOperationsCostComponents() []*engine.LineItem {
	costComponents := []*engine.LineItem{}
...
//
// FileStorage: n/a
func (r *StorageAccount) iterativeReadOperationsCostComponents() []*engine.LineItem {
	costComponents := []*engine.LineItem{}
...
//	Standard Cool: cost exists
//	Premium:       no cost
func (r *StorageAccount) readOperationsCostComponents() []*engine.LineItem {
	costComponents := []*engine.LineItem{}
...
//	Standard Cool: cost exists
//	Premium:       no cost
func (r *StorageAccount) otherOperationsCostComponents() []*engine.LineItem {
	costComponents := []*engine.LineItem{}
...
//	Standard Cool: cost exists
//	Premium:       no cost
func (r *StorageAccount) dataRetrievalCostComponents() []*engine.LineItem {
	costComponents := []*engine.LineItem{}
...
//	Standard Cool: no cost
//	Premium:       no cost
func (r *StorageAccount) dataWriteCostComponents() []*engine.LineItem {
	costComponents := []*engine.LineItem{}
...
//	Standard Cool: no cost
//	Premium:       no cost
func (r *StorageAccount) blobIndexTagsCostComponents() []*engine.LineItem {
	costComponents := []*engine.LineItem{}
...
//	Standard Cool: cost exists
//	Premium:       cost exists
func (r *StorageAccount) dataAtRestCostComponents() []*engine.LineItem {
	costComponents := []*engine.LineItem{}
...
//	Standard Cool: cost exists
//	Premium:       cost exists
func (r *StorageAccount) snapshotsCostComponents() []*engine.LineItem {
	costComponents := []*engine.LineItem{}
...
//	Standard Cool: cost exists
//	Premium:       no cost
func (r *StorageAccount) metadataAtRestCostComponents() []*engine.LineItem {
	costComponents := []*engine.LineItem{}
...
//	Standard Cool: cost exists
//	Premium:       no cost
func (r *StorageAccount) earlyDeletionCostComponents() []*engine.LineItem {
	costComponents := []*engine.LineItem{}
...
func (r *StorageAccount) buildStorageCostComponent(name string, startUsage string, quantity *decimal.Decimal) *engine.LineItem {
	meterName := "Data Stored"
