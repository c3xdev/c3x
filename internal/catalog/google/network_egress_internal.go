...
var StorageBucketNetworkEgressUsageSchema = []*engine.ConsumptionField{
	{ValueType: engine.Float64, DefaultValue: 0, Key: "same_continent"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "asia"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "worldwide"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "china"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "australia"},
}
...
func (r *StorageBucketNetworkEgressUsage) BuildResource() *engine.Estimate {
	...
	resource.CostComponents = append(resource.CostComponents, &engine.LineItem{
...
var ContainerRegistryNetworkEgressUsageSchema = []*engine.ConsumptionField{
	{ValueType: engine.Float64, DefaultValue: 0, Key: "same_continent"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "asia"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "worldwide"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "china"},
...
var ComputeVPNGatewayNetworkEgressUsageSchema = []*engine.ConsumptionField{
	{ValueType: engine.Float64, DefaultValue: 0, Key: "same_region"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "us_or_canada"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "europe"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "asia"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "south_america"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "oceania"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "worldwide"},
}
...
var ComputeExternalVPNGatewayNetworkEgressUsageSchema = []*engine.ConsumptionField{
	{ValueType: engine.Float64, DefaultValue: 0, Key: "asia"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "worldwide"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "china"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "australia"},
...
func egressStepPricingHelper(usage float64, usageFiltersData []*egressRegionUsageFilterData, regData *egressRegionData, defaultAPIRegionName, serviceName string) []*engine.LineItem {
	...
	for idx, usageFilter := range usageFiltersData {
		...
		attributeFilters := make([]*engine.AttributeMatch, 0)
		if regData.apiDescriptionRegex != "" {
			attributeFilters = append(attributeFilters, &engine.AttributeMatch{Key: "description", ValueRegex: strPtr(regData.apiDescriptionRegex)})
		} else {
			attributeFilters = append(attributeFilters, &engine.AttributeMatch{Key: "description", Value: strPtr(regData.apiDescription)})
		}
