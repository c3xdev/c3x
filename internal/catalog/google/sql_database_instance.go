...
func (r *SQLDatabaseInstance) costComponents(replica bool) *engine.Estimate {
...
func (r *SQLDatabaseInstance) sharedInstanceCostComponent() *engine.LineItem {
...
func (r *SQLDatabaseInstance) legacyMySQLInstanceCostComponent() *engine.LineItem {
	var resourceGroup string
	if r.IsStandard() {
...
func (r *SQLDatabaseInstance) instanceCostComponents() []*engine.LineItem {
...
func (r *SQLDatabaseInstance) storageCostComponent() *engine.LineItem {
	diskType := r.DiskType
...
func (r *SQLDatabaseInstance) backupCostComponent(quantity *decimal.Decimal) *engine.LineItem {
	return &engine.LineItem{
		Name:            "Backups",
		Unit:            "GB",
		UnitMultiplier:  decimal.NewFromInt(1),
...
func (r *SQLDatabaseInstance) ipv4CostComponent() *engine.LineItem {
	return &engine.LineItem{
