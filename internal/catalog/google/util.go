...
// This can be used as a engine.SubResourceUsage to define a structure that's
// commonly used with resources that vary on a per region basis.
var RegionUsageSchema = []*engine.ConsumptionField{
	{ValueType: engine.Float64, DefaultValue: 0, Key: "asia_east1"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "asia_east2"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "asia_northeast1"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "asia_northeast2"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "asia_northeast3"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "asia_south1"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "asia_south2"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "asia_southeast1"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "asia_southeast2"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "australia_southeast1"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "australia_southeast2"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "europe_central2"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "europe_north1"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "europe_west1"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "europe_west2"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "europe_west3"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "europe_west4"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "europe_west6"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "northamerica_northeast1"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "northamerica_northeast2"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "southamerica_east1"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "southamerica_west1"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "us_central1"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "us_east1"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "us_east4"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "us_west1"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "us_west2"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "us_west3"},
	{ValueType: engine.Float64, DefaultValue: 0, Key: "us_west4"},
}
...
func (r RegionsUsage) Values() []RegionUsage {
	...
	for i := 0; i < s.NumField(); i++ {
		...
		regions = append(regions, RegionUsage{
			Key:   underscore.ReplaceAllString(t.Field(i).Tag.Get("c3x_usage"), "-"),
...
func GetFloatFieldValueByUsageTag(tagValue string, s interface{}) float64 {
	...
	for i := 0; i < rt.NumField(); i++ {
		f := rt.Field(i)
		v := strings.Split(f.Tag.Get("c3x_usage"), ",")[0] // use split to ignore tag "options" like omitempty, etc.
		if v == tagValue {
			r := reflect.ValueOf(s)
