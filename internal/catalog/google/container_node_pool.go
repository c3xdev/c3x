...
// PopulateUsage parses the u engine.ConsumptionProfile into the ContainerNodePool.
// It uses the `c3x_usage` struct tags to populate data into the ContainerNodePool.
func (r *ContainerNodePool) PopulateUsage(u *engine.ConsumptionProfile) {
	catalog.PopulateArgsWithUsage(r, u)
}

// BuildResource builds a engine.Estimate from a valid ContainerNodePool struct.
...
func (r *ContainerNodePool) BuildResource() *engine.Estimate {
	...
	engine.ScaleQuantities(resource, nodeCount)
