...
func (r *KMSCryptoKey) UsageSchema() []*engine.ConsumptionField {
	return []*engine.ConsumptionField{{Key: "key_versions", ValueType: engine.Int64, DefaultValue: 0}, {Key: "monthly_key_operations", ValueType: engine.Int64, DefaultValue: 0}}
}
