...
import (
	...
	"github.com/c3xdev/c3x/internal/hclstack/tflint"
	...
	customMultierror := multierror.Error{
		...
		ErrorFormat: func(err []error) string {
			...
			for _, e := range err {
				...
				// https://github.com/c3xdev/c3x/internal/hclstack/issues/2045
...
func shouldRunHook(hook config.Hook, terragruntOptions *options.TerragruntOptions, previousExecErrors *multierror.Error) bool {
	...
	// resolves: https://github.com/c3xdev/c3x/internal/hclstack/issues/459
