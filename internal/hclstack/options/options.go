...
func NewTerragruntOptions() *TerragruntOptions {
	return &TerragruntOptions{
		...
		RunTerragrunt: func(opts *TerragruntOptions) error {
			return errtrace.WithStackTrace(RunTerragruntCommandNotSet)
		},
	}
}
...
func (opts *TerragruntOptions) Clone(terragruntConfigPath string) *TerragruntOptions {
	...
	// during xxx-all commands (e.g., apply-all, plan-all). See https://github.com/c3xdev/c3x/internal/hclstack/issues/367
	// for more info.
	return &TerragruntOptions{
...
// Check if argument is a planfile by extension.
