...
func createTestFile(filename, contents string) string {
	dir, err := os.MkdirTemp(os.TempDir(), "c3x")
	if err != nil {
		panic(err)
	}
...
`,
	...
	assert.JSONEq(
		...
		`[
			...
			{"foo":"10.0.0.0","bar":"input-c3x-mock-44956be29f34"},
			{"foo":"10.0.1.0","bar":"input-c3x-mock-44956be29f34"}
		]`,
		values,
	)
}
...
data "aws_subnets" "example" {
	...
	assertBlockEqualsJSON(
		t,
		`{"ids":["subnet-1-c3x-mock-44956be29f34", "subnet-2-c3x-mock-44956be29f34", "subnet-3-c3x-mock-44956be29f34"]}`,
...
`,
	...
	assertBlockEqualsJSON(
		t,
		`{"config":{"instance_type":"m5.4xlarge", "tags": "config-c3x-mock-44956be29f34"}}`,
		moduleBlock.Values(),
		"id", "arn", "self_link", "name", "source", "config_key",
	)
	...
	assertBlockEqualsJSON(
		t,
		`{"instance_type":"m5.4xlarge", "tags": "config-c3x-mock-44956be29f34"}`,
		resource.Values(),
		"id", "arn", "self_link", "name",
	)
}
...
`,
	...
	assertBlockEqualsJSON(
		t,
		`{"foo":0, "tags":"tags-c3x-mock-44956be29f34"}`,
		resource.Values(),
		"id", "arn", "self_link", "name",
	)
}
