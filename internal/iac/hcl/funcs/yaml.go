...
// YAMLDecodeFunc is a C3X specific version of the yaml.YAMLDecodeFunc
// which handles C3X mocked return values. If the argument passed to YAMLDecodeFunc
// is a C3X mock (e.g. a string with value mock-value) then we return a mocked object
