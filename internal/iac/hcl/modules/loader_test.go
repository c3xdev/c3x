...
func TestSourceMapGitModule(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "git without version",
			sourceMap: settings.TerraformSourceMap{
				"git::https://github.com/terraform-aws-modules/terraform-aws-ec2-instance.git": "git::https://github.com/c3x-tests/terraform-aws-ec2-instance.git",
			},
			want: []*ManifestModule{
				{
					Key:     "git-module",
					Source:  "git::https://github.com/c3x-tests/terraform-aws-ec2-instance.git?ref=v3.4.0",
					Version: "",
				},
			},
		},
		...
		},
		{
			...
			sourceMap: settings.TerraformSourceMap{
				"git::https://github.com/terraform-aws-modules/terraform-aws-ec2-instance.git?ref=v3.4.0": "git::https://github.com/c3x-tests/terraform-aws-ec2-instance.git?ref=master",
				"git::https://github.com/terraform-aws-modules/terraform-aws-ec2-instance.git":            "git::https://github.com/c3x-tests/terraform-aws-ec2-instance.git",
			},
			want: []*ManifestModule{
				{
					Key:     "git-module",
					Source:  "git::https://github.com/c3x-tests/terraform-aws-ec2-instance.git?ref=master",
					Version: "",
				},
			},
		},
