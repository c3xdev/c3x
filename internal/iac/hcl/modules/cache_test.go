...
func TestLookupModule(t *testing.T) {
	toStore := map[string]*ManifestModule{
		...
		"module-d": {
			Key:    "module-c",
			Source: "app.terraform.io/c3x/ec2-instance/aws",
			Dir:    ".c3x/module-c",
		},
		"submodule-a": {
			Key:     "submodule-a",
	...
	tests := []struct {
		...
		{"module-d", &tfconfig.ModuleCall{Source: "app.terraform.io/c3x/ec2-instance/aws"}, toStore["module-d"], ""},
