...
func TestIsPublic(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:       "private module",
			moduleAddr: "https://github.com/c3xdev/c3x-modules?ref=0.0.1",
			expected:   false,
		},
		{
		...
		},
		{
			...
			moduleAddr: "git::https://github.com/c3xdev/c3x-modules?ref=0.0.1",
			expected:   false,
		},
		{
			name:       "public with no scheme",
			moduleAddr: "github.com/c3xdev/c3x-modules?ref=0.0.1",
			expected:   false,
		},
		{
