...
var (
	...
	// to ensure that logging functionality is consistent across the C3X codebase.
	//
...
// This is used so that the logging packages does not use any other C3X packages,
