...
func getDataFactoryIntegrationRuntimeAzureSSISRegistryItem() *engine.CatalogEntry {
...
func newDataFactoryIntegrationRuntimeAzureSSIS(d *engine.ResourceSpec) engine.CatalogItem {
