...
func getDataFactoryIntegrationRuntimeAzureRegistryItem() *engine.CatalogEntry {
...
func newDataFactoryIntegrationRuntimeAzure(d *engine.ResourceSpec) engine.CatalogItem {
