...
func getImageRegistryItem() *engine.CatalogEntry {
...
func newImage(d *engine.ResourceSpec) engine.CatalogItem {
	region := d.Region
...
func imageStorageSize(d *engine.ResourceSpec) *float64 {
...
func getVMStorageSize(d *engine.ResourceSpec) float64 {
...
func getImageDiskStorage(d *engine.ResourceSpec) float64 {
...
func getDiskSizeGB(disk gjson.Result, refs []*engine.ResourceSpec, i int) float64 {
