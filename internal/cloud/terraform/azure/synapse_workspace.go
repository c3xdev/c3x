...
func synapseServerlessSQLPoolCostComponent(region, name, start string, quantity *decimal.Decimal) *engine.LineItem {
...
func synapseDataPipelineActivityRunCostComponent(region, name, sku, meter string, runs *decimal.Decimal) *engine.LineItem {
...
func synapseDataPipelineDataMovementCostComponent(region, name, sku, meter, unit string, diu, hours *decimal.Decimal) *engine.LineItem {
...
func synapseDataPipelineActivityIntegrationRuntimeCostComponent(region, name, sku, meter string, hours *decimal.Decimal) *engine.LineItem {
...
func synapseDataFlowCostComponent(region, name, tier string, instances, vCores, hours *decimal.Decimal) *engine.LineItem {
