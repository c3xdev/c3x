...
func getComputeRegionInstanceGroupManagerRegistryItem() *engine.CatalogEntry {
...
func newComputeRegionInstanceGroupManager(d *engine.ResourceSpec) engine.CatalogItem {
	targetSize := int64(1)
