...
type parseTagFunc func(baseTags, defaultTags map[string]string, r *engine.ResourceSpec, config TagParsingConfig)
...
func parseLaunchTemplateTags(tags, defaultTags map[string]string, r *engine.ResourceSpec, config TagParsingConfig) {
...
func ParseTags(externalTags, defaultTags map[string]string, r *engine.ResourceSpec, config TagParsingConfig) (map[string]string, []string) {
	...
	var missing []string
	tagsMissing := engine.ExtractMissingVarsCausingMissingAttributeKeys(r, "tags")
	missing = append(missing, tagsMissing...)
	tagsAllMissing := engine.ExtractMissingVarsCausingMissingAttributeKeys(r, "tags_all")
	...
	if supportsTagBlock {
		tagBlockMissing := engine.ExtractMissingVarsCausingMissingAttributeKeys(r, "tag")
...
func parseAutoScalingTags(tags, defaultTags map[string]string, r *engine.ResourceSpec, config TagParsingConfig) {
...
func parseInstanceTags(tags, defaultTags map[string]string, r *engine.ResourceSpec, config TagParsingConfig) {
...
func referencedTagSpecifications(r *engine.ResourceSpec, f func(resourceType string, specs map[string]gjson.Result)) {
