...
func TestEKSNodeGroupGoldenFile(t *testing.T) {
	...
	tftest.GoldenFileHCLResourceTestsWithOpts(t, "eks_node_group_test", tftest.DefaultGoldenFileOptions(), func(ctx *settings.Session) {
...
func TestEKSNodeGroup_spot(t *testing.T) {
	...
	tftest.ResourceTests(t, tf, engine.ConsumptionMap{}, resourceChecks)
}
